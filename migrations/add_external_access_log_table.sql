-- =========================================================
-- Migration: Externe Zugriffs-Log-Tabelle hinzufügen
-- Datum: 2026-05-03
-- Beschreibung: Protokollierung aller externen Zugriffe auf
--               Terminumfragen und Meinungsbilder
-- =========================================================
...
SELECT 'Tabelle svexternal_access_log erfolgreich erstellt oder bereits vorhanden' as status;
