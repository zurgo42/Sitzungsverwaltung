...
try {
    ...
    $tables[] = "CREATE TABLE IF NOT EXISTS svbproposals (
        ...
        co_department_id VARCHAR(20) NULL,
        organization_type ENUM('association', 'foundation') DEFAULT 'association',
        visibility ENUM('public', 'leadership', 'board', 'draft') DEFAULT 'public',
        ...
        -- Auswirkungen
        financial_amount DECIMAL(10,2) DEFAULT 0,
        ...
        meeting_id INT NULL,
        previous_proposal VARCHAR(15) NULL COMMENT 'Ursprüngliche Antragsnummer bei Status-Wechsel',

        -- Freigabe-Logik
        decision_type ENUM('single', 'department', 'board') DEFAULT 'board',
        simplified_approval ENUM('none', 'invoice_match', 'after_review') DEFAULT 'none',
        review_person VARCHAR(255) NULL,
        finance_approval TINYINT(1) DEFAULT 0,
        payment_note TEXT,

        -- Wartezeitverkürzung
        expedite_justification TEXT NULL,
        expedite_approver1_id INT NULL,
        expedite_approver2_id INT NULL,
        expedite_approved_at1 TIMESTAMP NULL,
        expedite_approved_at2 TIMESTAMP NULL,

        -- Workflow-Zeitstempel
        submitted_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
        finalized_at TIMESTAMP NULL COMMENT 'Antrag verbindlich gestellt',
        voting_deadline TIMESTAMP NULL,
        decided_at TIMESTAMP NULL,
        last_modified TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,

        -- Ergebnis (bei Beschlüssen)
    ...
    $tables[] = "CREATE TABLE IF NOT EXISTS svbproposal_attachments (
        ...
        file_url VARCHAR(500) NULL COMMENT 'Externe URL',
    ...
    $tables[] = "CREATE TABLE IF NOT EXISTS svbproposal_approvers (
        ...
        approver_role ENUM('primary', 'finance', 'secondary') NOT NULL,
    ...
    $tables[] = "CREATE TABLE IF NOT EXISTS svbproposal_comments (
        ...
        is_for_submitter TINYINT(1) DEFAULT 1 COMMENT 'An Antragsteller vs. allgemein',
        created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    ...
    $tables[] = "CREATE TABLE IF NOT EXISTS svbproposal_decision_rules (
        ...
        single_approval_max DECIMAL(10,2) DEFAULT 600.00,
        single_approval_monthly_max DECIMAL(10,2) DEFAULT 2000.00,
        department_approval_max DECIMAL(10,2) DEFAULT 3000.00,
        board_approval_min DECIMAL(10,2) DEFAULT 3000.00,
        ...
        -- Quorum
        min_board_members_present INT DEFAULT 3,

        active TINYINT(1) DEFAULT 1,
        created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,

        INDEX idx_active (active)
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Konfiguration der Entscheidungsregeln'";
    ...
    if ($stmt->fetch()['count'] == 0) {
        ...
        $pdo->exec("
            ...
            VALUES
            ('MinD Standard', 600.00, 2000.00, 3000.00, 3000.00, 7, 7, 7, 3, 1)
        ");
        echo ".";
        echo "<p style='color: green;'>✓ Default-Entscheidungsregeln eingefügt!</p>";
    } else {
        echo "<p style='color: orange;'>⚠ Entscheidungsregeln existieren bereits - überspringe</p>";
    }
